                                                ...
                                                <td>
                                                    @if (!empty($meter_main->image_1_old))
                                                        ...
                                                        <a href="{{ asset($meter_main->image_1_old) }}" target="_blank">
                                                            ...
                                                            style="height:47px;max-width:100%;"></a>
...
{{--  --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!empty($meter_main->image_2_new))
                                                        ...
                                                        <a href="{{ asset($meter_main->image_2_new) }}"
                                                                target="_blank"><img src="{{ asset($meter_main->image_2_new) }}" alt="photo1"
                                                                style="height:47px;max-width:100%;"></a>
                                                ...
                                                <td>
                                                    @if (!empty($meter_main->image_3_old))
                                                        {{-- <a href="{{ asset($meter_main->image_3_old) }}"
                                                            target="_blank"> <i class="fa fa-eye"></i></a> --}}
                                                        <a href="{{ asset($meter_main->image_3_old) }}"
                                                                target="_blank"><img src="{{ asset($meter_main->image_3_old) }}" alt="photo1"
                                                                style="height:47px;max-width:100%;"></a>
                                        ...
                                        <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                                            ...
                                            <a href="/contractors/delete_status_data/{{$meter_main->id}}" class="btn btn-danger">
