                ...
                <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                    <div class="card ongoing-project recent-orders">
                        ...
                        <div class="row container-fluid">
                            <div class="col-12">
                                <form method="GET" action="{{ url('/') }}/contractors/reports">
                                    @csrf
                                    <div class="row mb-2">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @php
                                            $count = 1;
                                        @endphp
                                        @foreach ($meter_replaced_date_wise as $meter_replaced)

                                        @php
                                            $admin = Admin::where('id',$meter_replaced->created_by)->first();

                                        @endphp
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$meter_replaced->created_date}}</td>
                                            <td>{{$admin->name}}</td>
                                            <td>{{$meter_replaced->record_count}}</td>
