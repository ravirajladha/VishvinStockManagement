...
<div id="layout-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            action="/qcs/bulk_approve_qcs_report" method="POST" enctype="multipart/form-data">
            @csrf
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/qcs/qc_view_detail/{{$meter_main->id}}" ><button type="button" class="btn btn-secondary">View</button></a></td>
