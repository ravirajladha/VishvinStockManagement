...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Inventory Executive</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Inventory</a></li>
                                <li class="breadcrumb-item active">Add Inventory Executive</li>
                            </ol>
                        </div>
            ...
            <form id="createproduct-form" autocomplete="off" class="needs-validation" action="create_inventory_executive" method="POST"  enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 mt-5">
                                    <label class="form-label" for="product-title-input">Inventory Executive Name <span class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="phone" name="phone" value="" placeholder="Enter Mobile Number" onkeyup="checkphn(this.value);" oninput="numberOnly(this.id);" maxlength="10"  required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <select class="form-control" name="type" required>
                                        <option value="" readonly>Select Type <span class="mandatory_star">*<sup><i>required</i></sup></span></option>
                                        <option value="1">Inventory</option>
                                        <option value="2">Annexure</option>
                                    </select>
                                </div>
