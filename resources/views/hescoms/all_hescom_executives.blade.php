                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">All HESCOM Users</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-nowrap align-middle mb-0">
                                            <thead>
                                                <tr>
                                                    <th scope="col">ID</th>
                                                    <th scope="col">Hescom Exective Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$user->name}}</td>
                                                    <td>{{$user->phone}}</td>
                                                    <td>@if($user->so_pincode){{$user->so_pincode}} @else {{'-'}} @endif</td>
                                                    <td>@if($user->sd_pincode){{$user->sd_pincode}} @else {{'-'}} @endif</td>
