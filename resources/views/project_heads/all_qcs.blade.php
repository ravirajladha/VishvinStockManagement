...
<head>
<title style="background-color:black;color:white;">View QC Managers (Vishvin)</title> 
</head>
            ...
            <div class="card">
                <div class="card-header border-0 rounded">
                    ...
                    <div class="justify-content-between" style="display: flex;">
                        ...
                        <a href="/project_heads/all_qcs" class="btn btn-dark add-btn">QC Manager (Vishvin)</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">View QC Managers (Vishvin)</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-nowrap align-middle mb-0">
                                            <thead>
                                                <tr>
                                                    <th scope="col">ID</th>
                                                    <th scope="col">QC (Vishvin) Name</th>
