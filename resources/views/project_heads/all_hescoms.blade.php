...
<head>
    ...
    <title style="background-color:black;color:white;">View HESCOM Officers</title>
            ...
            <div class="card">
                <div class="card-header border-0 rounded">
                    ...
                    <div class="justify-content-between" style="display: flex;">
                        <!--end col-->
                        <a href="/project_heads/all_inventory_managers" class="btn btn-primary add-btn">Inventory Managers</a>
                        ...
                        <a href="/project_heads/all_hescoms" class="btn btn-dark add-btn">HESCOM Officer</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">View HESCOM Officers</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-nowrap align-middle mb-0">
                                            <thead>
                                                <tr>
                                                    <th scope="col">ID</th>
                                                    <th scope="col">HESCOM (Officer) Name</th>
